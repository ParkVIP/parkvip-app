...
class BubbleWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Bubble(
        ...
        child: Padding(
          padding: const EdgeInsets.only(left: 5.0, right: 8, top: 5, bottom: 5),
          child: Column(
            ...
            children: [
              Column(
                ...
                children: [
                  Text( messageMap["author"]!=null ?  (messageMap['attributes'] == "true") ? "ChatGPT" : messageMap["fullname"] : '',
                  ...
                  Padding(
                    padding: EdgeInsets.only(top: MediaQuery.of(context).size.width * .015,right: MediaQuery.of(context).size.width * .01),
  ...
  String getDate(String utcDateTimeString) {
    ...
    String formattedDateTime =
        DateFormat('MM/dd/yyyy hh:mm a').format(istDateTime);
